                  ...
                  <tr>
                    ...
                    <td class="p-5 flex justify-center gap-2 items-center">
                      <div class="flex gap-2">
                        ...
                        <div>
                          <button type="submit" id="{{ $employee->id }}" token="{{ csrf_token() }}" route="/employees/destroy/" class="bg-red-500 hover:bg-red-600 px-4 py-2 text-white font-semibold font-medium gap-1 rounded-full flex items-center delete" >
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
