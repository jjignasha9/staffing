...
<div class="h-screen mt-5">
    ...
    <div class="flex items-center justify-end mb-5">
        <a href="{{ route('rates.create') }}" class="bg-blue-400 py-2 px-8 text-white font-semibold font-medium rounded-full hover:bg-blue-600">Add Rate</a>
    </div>
                  ...
                  <tr>
                    ...
                    <td class="p-5 flex justify-center gap-2 items-center">
                      <div class="flex gap-2">
                        <div>
                          <a href="{{ route('rates.edit',$rate->id) }}" class="bg-blue-400 hover:bg-blue-600 px-4 py-2 text-white font-semibold font-medium gap-1 rounded-full flex items-center">
