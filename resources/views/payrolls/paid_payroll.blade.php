	...
	<div class="col-span-10">
		...
		<div class="bg-white mt-5 p-5 rounded-lg">
			<div class="grid grid-cols-12">
				...
				<div class="col-span-3 font-semibold text-sm">
					<div class="bg-gray-200 w-28 py-1 px-2 flex gap-2 rounded-full"><span class="text-gray-500">draft</span> | <span class="text-teal-500">check</span></div>
				</div>
		...
		<div class="bg-white mt-5 p-5 rounded-lg">
			<div class="grid grid-cols-12">
				...
				<div class="col-span-3 font-semibold text-sm">
					<div class="bg-gray-200 w-32 py-1 px-2 flex gap-2 rounded-full"><span class="text-gray-500">pending</span> | <span class="text-teal-500">check</span></div>
				</div>
