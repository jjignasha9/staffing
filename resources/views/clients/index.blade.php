...
<div class="h-screen mt-5">
    ...
    <div class="flex items-center justify-end mb-5">
        <a href="{{ route('clients.create') }}" class="bg-teal-600 py-2 px-8 text-white font-semibold font-medium rounded-full hover:bg-teal-700">Add Client</a>
    </div>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $client->user_role->name }}</td>
                     ...
                     <td class="p-5 flex justify-center gap-2 items-center">
                      <div class="flex gap-2">
                        <div>
                          <a href="{{ route('clients.edit',$client->id) }}" class="bg-teal-600 hover:bg-teal-700 px-4 py-2 text-white font-semibold font-medium gap-1 rounded-full flex items-center">
