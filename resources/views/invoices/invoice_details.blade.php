	...
	<div class="bg-zinc-50 h-auto shadow-md rounded-lg">
		<div class="py-5 px-10">
			<div class="flex justify-between items-center">
				...
				stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/> </svg> </a> </div>
