                ...
                <center>
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="col-span-4 mt-5 border border-teal-700 p-10 bg-teal-50 rounded">
                            <h1 class="text-3xl text-teal-600 p-4 text-center font-bold font-serif tracking-wide">TimeSheet</h1>
                            <div>
                                <input id="email" type="email" placeholder="Username" class="h-6 w-full p-5 rounded mb-2 border focus:border-teal-600 outline-none @error('email') is-invalid @enderror" value="{{ old('email') }}"  name="email" required autocomplete="email" autofocus>
                            ...
                            <div>
                                <input id="password" type="password" placeholder="Password" class="h-6 w-full p-5 rounded border focus:border-teal-600 outline-none @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" value="{{ old('password') }}">
